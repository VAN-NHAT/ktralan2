...
//...
        ...
        arr_bean.add(new ListViewBean(R.drawable.ic_launcher_background, "Trần Văn Nhật"));
        arr_bean.add(new ListViewBean(R.drawable.ic_launcher_background, "Trần Văn Nhật"));
        arr_bean.add(new ListViewBean(R.drawable.ic_launcher_background,"Trần Võ Lập"));
        arr_bean.add(new ListViewBean(R.drawable.ic_launcher_background, "Trần Văn Nhật"));
